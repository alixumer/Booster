...
//
//public class pathFromLocation extends AsyncTask<String, Void, PolylineOptions> {
//
//    private String TAG = "GetPathFromLocation";
//    private String API_KEY = Constants.MAPS_API_KEY;
//    private List<LatLng> source, destination;
//    private DirectionPointListener resultCallback;
//
//    public pathFromLocation(List<LatLng> source, List<LatLng> destination, DirectionPointListener resultCallback) {
//        this.source = source;
//        this.destination = destination;
//        this.resultCallback = resultCallback;
//    }
//
//    public String getUrl(List<LatLng> origin, List<LatLng> dest) {
//
//        String str_origin = "origin=" + origin.add(lat) + "," + origin.longitude;
