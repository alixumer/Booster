...
public class OrderDetailsSellerActivity extends AppCompatActivity {
    ...
    private void editOrderStatus(final String selectedOption) {
        //setup data tp put in firebase dp
    ...
    private void loadOrderDetails() {
        //load detailed info of the order, based on order id
        DatabaseReference ref = FirebaseDatabase.getInstance().getReference("Users");
        ref.child(firebaseAuth.getUid()).child("Orders").child(orderId)
    ...
    private void preparedNotificationMessage(String orderId, String message){
        //when user seller changes order status InProgress/Completed/Cancelled, send notifications to buyer
